...
<!-- Mirrored from themesdesign.in/tailwick/html/tables-datatable.html by HTTrack Website Copier/3.x [XR&CO'2014], Mon, 07 Oct 2024 14:29:40 GMT -->

<head>

    <meta charset="utf-8">
    <title>Aplikasi Maintenance Lab Komputer</title>
                            ...
                            <div class="absolute z-50 hidden p-4 ltr:text-left rtl:text-right bg-white rounded-md shadow-md !top-4 dropdown-menu min-w-[14rem] dark:bg-zink-600" aria-labelledby="dropdownMenuButton">
                                ...
                                <ul>
                                    ...
                                    <li class="pt-2 mt-2 border-t border-slate-200 dark:border-zink-500">
                                        <a class="block ltr:pr-4 rtl:pl-4 py-1.5 text-base font-medium transition-all duration-200 ease-linear text-slate-600 dropdown-item hover:text-custom-500 focus:text-custom-500 dark:text-zink-200 dark:hover:text-custom-500 dark:focus:text-custom-500" href=" ../inc/logout.php"><i data-lucide="log-out" class="inline-block size-4 ltr:mr-2 rtl:ml-2"></i> Sign Out</a>
                                    </li>
                                </ul>
                            </div>
                        </div>
...
<!-- Mirrored from themesdesign.in/tailwick/html/tables-datatable.html by HTTrack Website Copier/3.x [XR&CO'2014], Mon, 07 Oct 2024 14:29:42 GMT -->
