...
$sql = "SELECT tbl_admin.*, tbl_users.* FROM tbl_admin 
	LEFT JOIN tbl_users ON tbl_admin.id_user = tbl_users.id_user WHERE tbl_admin.
    id_user='$id'  ";
        ...
        <div class="container-fluid group-data-[content=boxed]:max-w-boxed mx-auto">
            ...
            <div class="flex flex-col gap-2 py-4 md:flex-row md:items-center print:hidden">
                ...
                <ul class="flex items-center gap-2 text-sm font-normal shrink-0">
                    ...
                    <li class="relative before:content-['\ea54'] before:font-remix ltr:before:-right-1 rtl:before:-left-1  before:absolute before:text-[18px] before:-top-[3px] ltr:pr-4 rtl:pl-4 before:text-slate-400 dark:text-zink-200">
                        <a href="?pages=user_admin&aksi=tampil" class="text-slate-400 dark:text-zink-200">Tampil User Admin</a>
                    </li>
            ...
            <div class="card">
                <div class="card-body">
                    <h6 class="mb-4 text-15">View Admin Biasa</h6>
                    <form method="post" enctype="multipart/form-data">
                        <div class="grid grid-cols-1 gap-x-5 md:grid-cols-2 xl:grid-cols-6">
                            <div class="mb-4">
                                ...
                                <input type="text" id="inputIdAdmin" name="id_admin" class="form-input border-slate-200 dark:border-zink-500 focus:outline-none focus:border-custom-500 disabled:bg-slate-100 dark:disabled:bg-zink-600 disabled:border-slate-300 dark:disabled:border-zink-500 dark:disabled:text-zink-200 disabled:text-slate-500 dark:text-zink-100 dark:bg-zink-700 dark:focus:border-custom-800 placeholder:text-slate-400 dark:placeholder:text-zink-200" value="<?= $id; ?>" readonly>
                            </div>
                            <div class="mb-4">
