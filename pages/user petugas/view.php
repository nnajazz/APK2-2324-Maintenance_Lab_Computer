...
<div class="relative min-h-screen group-data-[sidebar-size=sm]:min-h-sm">
    ...
    <div class="group-data-[sidebar-size=lg]:ltr:md:ml-vertical-menu group-data-[sidebar-size=lg]:rtl:md:mr-vertical-menu group-data-[sidebar-size=md]:ltr:ml-vertical-menu-md group-data-[sidebar-size=md]:rtl:mr-vertical-menu-md group-data-[sidebar-size=sm]:ltr:ml-vertical-menu-sm group-data-[sidebar-size=sm]:rtl:mr-vertical-menu-sm pt-[calc(theme('spacing.header')_*_1)] pb-[calc(theme('spacing.header')_*_0.8)] px-4 group-data-[navbar=bordered]:pt-[calc(theme('spacing.header')_*_1.3)] group-data-[navbar=hidden]:pt-0 group-data-[layout=horizontal]:mx-auto group-data-[layout=horizontal]:max-w-screen-2xl group-data-[layout=horizontal]:px-0 group-data-[layout=horizontal]:group-data-[sidebar-size=lg]:ltr:md:ml-auto group-data-[layout=horizontal]:group-data-[sidebar-size=lg]:rtl:md:mr-auto group-data-[layout=horizontal]:md:pt-[calc(theme('spacing.header')_*_1.6)] group-data-[layout=horizontal]:px-3 group-data-[layout=horizontal]:group-data-[navbar=hidden]:pt-[calc(theme('spacing.header')_*_0.9)]">
        <div class="container-fluid group-data-[content=boxed]:max-w-boxed mx-auto">
            ...
            <div class="card">
                <div class="card-body">
                    <h6 class="mb-4 text-15">View Petugas</h6>
                        ...
                        <div class="grid grid-cols-1 gap-x-5 md:grid-cols-2 xl:grid-cols-6">
                            ...
                            <div class="mb-3 row">
                                ...
                                <div class="col-md-10">
                                    <input class="form-check-input" type="radio" name="jenkel" value="L"
                                        <?php if ($jenkel == 'L') echo 'checked'; ?> disabled>
                                    <label class="form-check-label">Laki-Laki</label>

                                    <div class="form-check">
                                        <input class="form-check-input" type="radio" name="jenkel" value="P"
                                            <?php if ($jenkel == 'P') echo 'checked'; ?> disabled>
                                        <label class="form-check-label">Perempuan</label>
                                    </div>
                                </div>
                            </div>
                            <input type="hidden" name="jenkel" value="<?= htmlspecialchars($jenkel) ?>">
                            ...
                            <div class="mb-4">
                                ...
                                <select class="form-select border-slate-200 dark:border-zink-500 focus:outline-none focus:border-custom-500 disabled:bg-slate-100 dark:disabled:bg-zink-600 disabled:border-slate-300 dark:disabled:border-zink-500 dark:disabled:text-zink-200 disabled:text-slate-500 dark:text-zink-100 dark:bg-zink-700 dark:focus:border-custom-800 placeholder:text-slate-400 dark:placeholder:text-zink-200"
                                    ...
                                    <?php
                                    $SQL_BRANCH = "SELECT * FROM tbl_lab" or die("data tidak ditemukan..!!" . mysqli_error($KONEKSI));
                                    $DATA_BRANCH = mysqli_query($KONEKSI, $SQL_BRANCH);

                                    while ($BRANCH = mysqli_fetch_assoc($DATA_BRANCH)) {
                                        $SELECT = ($id_lab == $BRANCH['id_lab']) ? "selected" : "";
                            ...
                            <input type="hidden" name="nama_lab" value="<?= htmlspecialchars($id_lab) ?>">
