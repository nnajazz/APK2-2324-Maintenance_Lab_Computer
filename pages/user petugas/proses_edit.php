...
$id_petugas           = stripslashes($_POST['kode']);
$email                = stripslashes($_POST['email']);
$nama_petugas         = stripslashes($_POST['nama_petugas']);
$telepon              = stripslashes($_POST['telepon']);
$lab               = stripslashes($_POST['nama_lab']);
...
if ($id_petugas == "" || $email == "" || $nama_petugas == "" || $telepon == "" || $lab =="" || $jenkel == "" || $foto_lama == "") {
    ?>
    ...
    if (isset($foto_lama)) {
       ...
       if (edit_petugas($_POST, $_FILES, $target)> 0) {
