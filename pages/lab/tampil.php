		...
		<div class="container-fluid group-data-[content=boxed]:max-w-boxed mx-auto">
			...
			<div class="flex flex-col gap-2 py-4 md:flex-row md:items-center print:hidden">
				...
				<ul class="flex items-center gap-2 text-sm font-normal shrink-0">
					...
					<li class="relative before:content-['\ea54'] before:font-remix ltr:before:-right-1 rtl:before:-left-1  before:absolute before:text-[18px] before:-top-[3px] ltr:pr-4 rtl:pl-4 before:text-slate-400 dark:text-zink-200">
						<a href="?pages=lab&aksi=tampil" class="text-slate-400 dark:text-zink-200">lab</a>
					</li>
			...
			<div class="card">
				<div class="card-body">
					<h6 class="mb-4 text-15">Tampil lab</h6>
					<div class="mb-3">

						<a href="?pages=lab&aksi=tambah" class="text-white transition-all duration-200 ease-linear btn bg-custom-500 border-custom-500 hover:text-white hover:bg-custom-600 hover:border-custom-600 focus:text-white focus:bg-custom-600 focus:border-custom-600 focus:ring focus:ring-custom-100 active:text-white active:bg-custom-600 active:border-custom-600 active:ring active:ring-custom-100" id="addRow">Tambah Biasa</a>
								...
								<div class="card-body">
									...
									<form action="#!">
										...
										<div class="flex justify-end gap-2 mt-3">
											<button type="button" class="text-red-500 bg-white btn hover:text-red-500 hover:bg-red-100 focus:text-red-500 focus:bg-red-100 active:text-red-500 active:bg-red-100 dark:bg-zink-700 dark:hover:bg-red-500/10 dark:focus:bg-red-500/10 dark:active:bg-red-500/10"><i data-lucide="x" class="inline-block size-4"></i> <span class="align-middle"><a href="?pages=lab&aksi=tampil">Cancel</a></span></button>
					...
					<table id="tableDynamically" class="display" style="width:100%">
						...
						<tbody>
							...
							$sql = "SELECT * FROM tbl_lab ORDER BY id_lab ASC";
							...
							?>
								<tr>
									...
									<td><?= $user['jumlah_pc']; ?></td>

									<td class="">
										<details>
											<summary>⋮</summary>
											<a href="?pages=lab&aksi=view&id=<?php echo $user['id_lab']; ?>">View</a><br>
											<a href="#" data-bs-toggle="modal" data-modal-target="extraLargeModall<?= $user['id_lab']; ?>">View Modal</a><br>
											<a href="?pages=lab&aksi=edit&id=<?php echo $user['id_lab']; ?>">Edit</a><br>
											<a href="#" data-bs-toggle="modal" data-modal-target="extraLargeModalEdit<?= $user['id_lab']; ?>">Edit Modal</a><br>
											<a href="?pages=lab&aksi=hapus&id=<?php echo $user['id_lab']; ?>">Delete</a><br>
										</details>
									</td>
